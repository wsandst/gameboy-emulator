...
fn main() {
    ...
    .arg(Arg::new("filename")
         .help("Select a ROM file to load")
         .required(true)
         .value_name("ROMFILE"))
    .arg(Arg::new("savefile")
         .help("Select a savefile (.save) to load")
         .short('s')
         .long("savefile")
         .takes_value(true)
         .value_name("SAVEFILE"))
    .arg(Arg::new("bootrom")
         .help("Select a bootrom to use. Not required.")
         .short('b')
         .long("bootrom")
         .takes_value(true)
         .value_name("BOOTROMFILE"))
    .arg(Arg::new("audiosync")
        .help("Select audio syncing strategy.")
        .long("audiosync")
        .takes_value(true)
        .value_name("STRATEGY")
